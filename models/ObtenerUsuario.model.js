...
async function QueryObtenerUsuario(usuario) {
  let code = 200;
  ...
  try {
    ...
    const result = await request.query('EXEC reserva.spr_ObtenerDatosUsuario @usuario');
...
module.exports = {
    QueryObtenerUsuario: QueryObtenerUsuario
};
